...
/**
 * Body of the "Faturas" sub-tab inside [CardsHubScreen]: all statements across cards, with a date filter.
 * The hub provides the surrounding scaffold/top bar.
 */
@Composable
fun AllStatementsContent(
    modifier: Modifier,
